...
export default function LoginPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      // Step 2: Send to backend — same route as user/admin
  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 28 }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        <div style={{ width: 64, height: 64, background: PINK, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, margin: "0 auto 12px" }}>
          🧑‍🍽️
        </div>
        <div style={{ color: WHITE, fontSize: 24, fontWeight: 800 }}>আড্ডা Waiter</div>
        <div style={{ color: "#666", fontSize: 12, letterSpacing: 3, marginTop: 3 }}>ORDER MANAGEMENT</div>
      </div>
      ...
      <div style={{ background: "#16162a", borderRadius: 20, padding: 28, width: "100%" }}>
        ...
        {step === "phone" ? (
          <>
            <div style={{ color: WHITE, fontWeight: 600, fontSize: 16, marginBottom: 20 }}>Sign In</div>
            ...
            <button
              onClick={handleSend}
              disabled={loading}
              style={{ width: "100%", padding: "14px", borderRadius: 30, border: "none", background: loading ? "#555" : PINK, color: WHITE, fontWeight: 800, fontSize: 15, cursor: loading ? "not-allowed" : "pointer" }}
            >
          ...
          <>
            <div style={{ color: WHITE, fontWeight: 600, fontSize: 16, marginBottom: 6 }}>Verify OTP</div>
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "center", marginBottom: 16 }}>
              {otp.map((v, i) => (
                <input
                  ...
                  style={{ width: 46, height: 54, textAlign: "center", border: `2px solid ${v ? PINK : "#2a2a3e"}`, borderRadius: 12, background: "#16162a", color: WHITE, fontSize: 22, fontWeight: 700, outline: "none" }}
                />
              ))}
            </div>
            ...
            <div style={{ textAlign: "center", color: "#666", fontSize: 13, marginBottom: 24 }}>
              {timer > 0 ? (
                ...
                <span onClick={handleResend} style={{ color: PINK, cursor: "pointer", fontWeight: 700 }}>
                  Resend OTP
                </span>
              )}
            </div>
            ...
            <div
              onClick={() => { setStep("phone"); setOtp(Array(6).fill("")); window.confirmationResult = null; }}
